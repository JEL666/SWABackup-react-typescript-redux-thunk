...
const Spinner = ({ size = 24, color = '#919EAB', ...props}: Props) => {
    const sizeStyle = {
        width: size,
        height: size
    };
    ...
    return <Icon>
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={sizeStyle}>
            <rect x="1" y="1" rx="1" width="10" height="10" fill={color}>
            ...
            <rect x="1" y="13" rx="1" width="10" height="10" fill={color}>
            ...
            <rect x="13" y="13" rx="1" width="10" height="10" fill={color}>
